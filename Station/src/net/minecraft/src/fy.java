...
extends ay {
    public boolean a(World dp2, Random random, int n2, int n3, int n4) {
        for (int i2 = 0; i2 < 20; ++i2) {
            ...
            if (dp2.a(n7, n5 = n3, n6 = n4 + random.nextInt(4) - random.nextInt(4)) != 0 || dp2.c(n7 - 1, n5 - 1, n6) != Material.f && dp2.c(n7 + 1, n5 - 1, n6) != Material.f && dp2.c(n7, n5 - 1, n6 - 1) != Material.f && dp2.c(n7, n5 - 1, n6 + 1) != Material.f) continue;
